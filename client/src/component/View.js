    ...
    return (
        <div className='container mt-5'>
            ...
            <ul className="list-group w-50 mt-4">
                ...
                <li className="list-group-item">Student ka Name:- {getstud.name}</li>
                <li className="list-group-item">Student ka Address:-  {getstud.address}</li>
                <li className="list-group-item">Student ka Subject:-  {getstud.subject}</li>
                <li className="list-group-item">Student ka Mobile:-  {getstud.contact}</li>
            </ul>
